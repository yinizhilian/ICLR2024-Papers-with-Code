...
- Paper: [**点击下载**](https://openreview.net/attachment?id=WAid50QschI&name=pdf)
- Code: [https://github.com/deep-spin/sparse-communication](https://github.com/deep-spin/sparse-communication)

23、Real-Time Neural Voice Camouflage
- Paper: [**点击下载**](https://openreview.net/attachment?id=qj1IZ-6TInc&name=pdf)
- Code: [http://voicecamo.cs.columbia.edu](http://voicecamo.cs.columbia.edu)
...
- Paper: [**点击下载**](https://openreview.net/attachment?id=uSE03demja&name=pdf)
- Code: [http://risp.csail.mit.edu](http://risp.csail.mit.edu)

25、CycleMLP: A MLP-like Architecture for Dense Prediction
- Paper: [**点击下载**](https://openreview.net/attachment?id=NMEceG4v69Y&name=pdf)
